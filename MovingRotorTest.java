...
public class MovingRotorTest {
    ...
    public void checkatnotch() {
        ...
        String str1 = "(ALTPHQXRU) (BKNW) (CMOY) (DFG) (IV) (JZ) (S)";
        Permutation perm1 = new Permutation(str1, alpha1);
        MovingRotor m1 = new MovingRotor("I", perm1, "Q");
        m1.set(16);
        assertTrue(m1.atNotch());
        MovingRotor m2 = new MovingRotor("I", perm1, "Q");
        m2.set(0);
        assertFalse(m2.atNotch());
    }
}
